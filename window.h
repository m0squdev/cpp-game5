...
#define KET_BACKSLASH        GLFW_KEY_BACKSLASH
...
#define KEY_PRINT            GLFW_KEY_PRINT_SCREEN
...
#define KEY_KP_DOT           GLFW_KEY_KP_DECIMAL
#define KEY_KP_SLASH         GLFW_KEY_KP_DIVIDE
#define KEY_KP_ASTERISK      GLFW_KEY_KP_MULTIPLY
#define KEY_KP_MINUS         GLFW_KEY_KP_SUBTRACT
#define KEY_KP_PLUS          GLFW_KEY_KP_ADD
...
class Window
{
    public:
        ...
        static GameWindow Create(char* title, int width, int height, bool fullscreen = false);
        static void Delete();

        static int GetBufferWidth();
        static int GetBufferHeight();

        static void Bind(GameWindow window = currentWindow);
    ...
    private:
        ...
        static void KeyListener(GameWindow window, int key, int code, int action, int mode);
        static void MouseListener(GameWindow window, double xPos, double yPos);
};