...
public:
    ...
    static void CreatePoint(GLfloat constant, GLfloat linear, GLfloat exponent, GLfloat x = currentPointX, GLfloat y = currentPointY, GLfloat z = currentPointZ, GLfloat r = 1.f, GLfloat g = 1.f, GLfloat b = 1.f);
